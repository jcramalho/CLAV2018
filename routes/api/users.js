...
router.post('/registar', Auth.isLoggedInUser, Auth.checkLevel(4), [
...
router.post('/registarParaEntidade', Auth.isLoggedInUser, Auth.checkLevel(4), [
    verificaExisteEnt('body', 'entidade'),
...
router.put('/:id/desativar', Auth.isLoggedInUser, Auth.checkLevel(4), [
...
//Registo via CC
router.post('/registarCC', Auth.isLoggedInUser, Auth.checkLevel(4), [
    verificaExisteEnt('body', 'entidade'),
    existe('body', 'name'),
    existe('body', 'email')
        .bail()
